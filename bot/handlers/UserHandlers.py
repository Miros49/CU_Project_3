...
async def start_command(message: Message):
    await message.answer("Привет! Я бот прогноза погоды. Используйте команду /weather для запроса прогноза.")
...
# Обработка выбора "Выбрать на карте"
...
# Обработка выбора "Ввести вручную"
...
# Обработка ручного ввода начальной точки маршрута
...
# Обработка геолокации начальной точки маршрута
